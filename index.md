...
- [4주차 영상과 작업 결과 ](https://hawasu.github.io/files/4주차.html
 "이것은 4주차 영상입니다.")  
- [5주차 영상과 작업 결과 ](https://hawasu.github.io/files/5주차.html
 "이것은 5주차 영상입니다.") 
 - [6주차 영상과 작업 결과 ](https://hawasu.github.io/files/6주차.html
 "이것은 6주차 영상입니다.") 
...
- 게임 화면 박스 카운트 함수 이용 타겟에 박스 갯수만큼 모두 접촉이 되면 포탈과 함정 표시  
:: 현재 특정 타겟에 박스가 부딪치면 포탈 및 함정이 드러나게 되어 타겟을 찾아야 스테이지를 클리어 할수 있음   
<br>
...
:: (수정) 스테이지 4개 -> 2개  
:: 동화의 스토리는 제외하고 진행되고 있는 스테이지의 스토리만 구현
