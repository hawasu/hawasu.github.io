...
|이름|주인공|
|나이|18|
|체력|이동 횟수| 이동 횟수를 체력으로 치환<br>함정에 걸리거나 이동할때마다 -1씩 차감|
...
| :--------:|:--------:|:--------:|---------:|
|이름|아실링|
|방향성| 플레이어의 길잡이| 플레이어의 수월한 진행을 위한 길잡이 역할|
...
|속성|속성 값|설명|비고|  
| :--------:|:--------:|:--------:|---------:|
|체력|이동 횟수|함정에 걸릴시 기본 이동횟수 1 차감|
|종료| 게임 실패| 함정 속 미니게임 실패 시, <br>해당 라운드 통과 실패|
...
|속성|속성 값|설명|비고|  
| :--------:|:--------:|:--------:|---------:|  
|목표|스테이지 클리어| 현 스테이지 클리어 완료<br> 다음 스테이지로 넘어감|
